...
buyBtn.addEventListener("click", async () => {
  const { data } = await useFetch("https://be-website-sepatu.vercel.app/api/cart/checkout", {
    method: "POST",
    headers: {
...
async function deleteFromCart(id) {
  const { data } = await useFetch("https://be-website-sepatu.vercel.app/api/cart/", {
    method: "DELETE",
    headers: {
      "Content-Type": "application/json",
      authorization: "Bearer " + localStorage.getItem("token"),
...
const renderPricing = async () => {
  ...
  const { data } = await useFetch("https://be-website-sepatu.vercel.app/api/cart/total", {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
      authorization: "Bearer " + localStorage.getItem("token"),
